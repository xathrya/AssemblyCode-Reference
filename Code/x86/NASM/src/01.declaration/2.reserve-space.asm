...
; 
; When generating the binary code, NASM will create a stream of bytes in the
; corresponding setion. This stream of data is unintialized or filled with zeroes.
;
