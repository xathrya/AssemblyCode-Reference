...
; A constant can be declared by using 'equ' (equate) instruction. There would
; be no space allocation in the final code. The symbol or token is simple 
; will be evaluate later and any occurrence of it will be replaced by corresponding value.
;
...
; Another equivalent instruction for declaring a constant is using %define
; The %define instruction can be placed anywhere, it could be even placed
; inside a scope of function.
...
; If we illustrate the memory layout, it would be something like this
; (assuming that the address of code is directly after the data section)
;
