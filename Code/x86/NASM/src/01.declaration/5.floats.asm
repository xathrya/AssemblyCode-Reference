...
; A special operators are used to produce floating-point numbers in other contexts.
; They produce the binary representations of a specific floating numbers as
; an integer and can use anywhere integer constants are used in an expression.
...
; As of IEEE754 specification, special tokens of infinity and NaN representation also exists.
