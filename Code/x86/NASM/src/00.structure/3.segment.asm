...
; is used to contain a specific type of data. Either data, code, or stack.
; When thing goes out of segment boundary, you will get the infamous message
; "segmentation fault"
;
; Segment is closely related but not same as section. A section will indicate
; section of data in object file or executable format. It will be a hint for
; OS to load correct thing to the correct place. While the segment is a
; runtime memory area that is reserved for a purpose.
;
...
; Stack segment
; Created by OS and not represented by any section.
; Contains values passed to functions and procedures within the program